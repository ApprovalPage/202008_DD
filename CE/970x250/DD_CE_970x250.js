...
lib.ssMetadata = [
		{name:"DD_CE_970x250_atlas_P_1", frames: [[0,0,194,400],[0,402,194,400],[196,0,194,400],[196,402,194,400]]},
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-221.35,139.5,1.2395,1.2395,0,0,0,88.5,25);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(179).to({_off:false},0).to({x:259.3},9,cjs.Ease.quadOut).wait(40).to({x:-212.6},11).to({_off:true},1).wait(62));

	// HEAD2bHist
	this.instance_1 = new lib.HEAD2bHist();
	this.instance_1.setTransform(-221.35,139.5,1.2395,1.2395,0,0,0,88.5,25);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(135).to({_off:false},0).to({x:259.3},9,cjs.Ease.quadOut).wait(26).to({x:-220.05},9,cjs.Ease.quintIn).to({_off:true},1).wait(122));

	// HEAD2bPlan
	this.instance_2 = new lib.HEAD2bPlan();
	this.instance_2.setTransform(-190.05,139.5,1.2395,1.2395,0,0,0,88.5,25);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(91).to({_off:false},0).to({x:259.3},9,cjs.Ease.quintOut).wait(26).to({x:-190.05},9,cjs.Ease.quintIn).to({_off:true},1).wait(166));
	...
	this.instance_3.setTransform(530.85,125.1,0.5553,0.5553,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(188).to({_off:false},0).to({x:623.6},9).wait(31).to({regY:200.1,x:762.4,y:263.95},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));
	...
	this.instance_4.setTransform(530.85,125.1,0.5553,0.5553,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(144).to({_off:false},0).to({x:623.6},9).wait(35).to({x:715.8},9).to({_off:true},1).wait(104));
	...
	this.instance_5.setTransform(762.4,263.95,0.5553,0.5553,0,0,0,97,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(86).to({_off:false},0).to({regY:200,x:623.6,y:125.1},9).wait(49).to({x:716.9},9).to({_off:true},1).wait(148));

	// iPhone
	this.instance_6 = new lib.iPhone_1();
	this.instance_6.setTransform(810.2,310.1,0.5553,0.5553,0,0,0,181,283.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(86).to({_off:false},0).to({regX:181.1,regY:283.1,x:671.4,y:171.25},9).wait(133).to({regX:181,regY:283.2,x:810.2,y:310.1},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// HEAD2a
	this.instance_7 = new lib.HEAD2a();
	this.instance_7.setTransform(260,85.55,1.2395,1.2395,0,0,0,90,17);
	...
	this.instance_8.setTransform(250,89.35,1,1,0,0,0,129.5,15.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(74).to({alpha:0},5).to({_off:true},1).wait(160).to({_off:false,regX:129.6,regY:15.5,scaleX:0.9737,scaleY:0.9737,x:177.2,y:122.95,alpha:1},0).wait(62));

	// EndFrame1
	this.instance_9 = new lib.HEAD_MySmile();
	this.instance_9.setTransform(1101.85,534.45,1.2046,1.2046,0,0,0,135.6,93);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(250).to({_off:false},0).to({x:754.9,y:187.5},25,cjs.Ease.quintOut).wait(27));

	// EndFrame0
	this.instance_10 = new lib.HEAD_WelcomeTo();
	this.instance_10.setTransform(525.8,113.9,0.9598,0.9598,0,0,0,83.1,25.1);
...
p.nominalBounds = new cjs.Rectangle(154,125,1171,734.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_CE_970x250_atlas_P_1.png?1597686395892", id:"DD_CE_970x250_atlas_P_1"},
		{src:"images/DD_CE_970x250_atlas_NP_1.jpg?1597686395892", id:"DD_CE_970x250_atlas_NP_1"}
	],
	preloads: []
};
