...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(778,118.55);
	...
	this.instance_1.setTransform(508,180.05,1,1,0,0,0,0,25);
	...
	this.instance_2.setTransform(502.6,448.95,1.3999,1.3999,0,0,0,197.2,132.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(240).to({_off:false},0).to({regX:197.1,x:322.6,y:268.95},10,cjs.Ease.quadOut).wait(52));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(179).to({_off:false},0).to({x:259.3},9,cjs.Ease.quadOut).wait(40).to({x:-212.6},11).to({_off:true},1).wait(62));

	// HEAD2bHist
	this.instance_4 = new lib.HEAD2bHist();
	this.instance_4.setTransform(-221.35,139.5,1.2395,1.2395,0,0,0,88.5,25);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(135).to({_off:false},0).to({x:259.3},9,cjs.Ease.quadOut).wait(26).to({x:-220.05},9,cjs.Ease.quintIn).to({_off:true},1).wait(122));

	// HEAD2bPlan
	this.instance_5 = new lib.HEAD2bPlan();
	this.instance_5.setTransform(-190.05,139.5,1.2395,1.2395,0,0,0,88.5,25);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(91).to({_off:false},0).to({x:259.3},9,cjs.Ease.quintOut).wait(26).to({x:-190.05},9,cjs.Ease.quintIn).to({_off:true},1).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(188).to({_off:false},0).to({x:623.6},9).wait(31).to({regY:200.1,x:762.4,y:263.95},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));
	...
	this.instance_7.setTransform(530.85,125.1,0.5553,0.5553,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(144).to({_off:false},0).to({x:623.6},9).wait(35).to({x:715.8},9).to({_off:true},1).wait(104));
	...
	this.instance_8.setTransform(762.4,263.95,0.5553,0.5553,0,0,0,97,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(86).to({_off:false},0).to({regY:200,x:623.6,y:125.1},9).wait(49).to({x:716.9},9).to({_off:true},1).wait(148));

	// iPhone
	this.instance_9 = new lib.iPhone_1();
	this.instance_9.setTransform(810.2,310.1,0.5553,0.5553,0,0,0,181,283.2);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(86).to({_off:false},0).to({regX:181.1,regY:283.1,x:671.4,y:171.25},9).wait(133).to({regX:181,regY:283.2,x:810.2,y:310.1},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// HEAD2a
	this.instance_10 = new lib.HEAD2a();
	this.instance_10.setTransform(260,85.55,1.2395,1.2395,0,0,0,90,17);
	...
	this.instance_11.setTransform(250,89.35,1,1,0,0,0,129.5,15.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(74).to({alpha:0},5).to({_off:true},1).wait(160).to({_off:false,x:179.05,y:49.35,alpha:1},0).wait(62));

	// HEAD1
	this.instance_12 = new lib.HEAD1();
	this.instance_12.setTransform(887.45,413.5,1,1,0,0,0,135.5,93);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(21).to({_off:false},0).to({x:599.45,y:125.5},25,cjs.Ease.quintOut).wait(34).to({x:879.45,y:405.5},5,cjs.Ease.quadIn).to({_off:true},1).wait(216));

	// HEAD0
	this.instance_13 = new lib.HEAD0();
	this.instance_13.setTransform(202.95,145,1,1,0,0,0,83,25);
	...
	this.instance_14.setTransform(588,303,1,1,-90);

	this.instance_15 = new lib.CE300x600bkgd15();
	this.instance_15.setTransform(3,303,1,1,-90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_15},{t:this.instance_14}]}).wait(302));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_CE_970x250_atlas_P_1.png?1597703876230", id:"DD_CE_970x250_atlas_P_1"},
		{src:"images/DD_CE_970x250_atlas_NP_1.jpg?1597703876230", id:"DD_CE_970x250_atlas_NP_1"}
	],
	preloads: []
};
