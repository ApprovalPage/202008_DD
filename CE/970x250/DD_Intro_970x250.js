...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1151.75,611.55,1.3778,1.3778,0,0,0,197,132);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(288).to({_off:false},0).to({x:765.95,y:225.8},10,cjs.Ease.quadOut).wait(52));

	// HEAD2bDent
	this.instance_1 = new lib.HEAD2b_EstCosts();
	this.instance_1.setTransform(-196.15,82.9,1.2386,1.2386,0,0,0,88.5,25.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(217).to({_off:false},0).to({x:246},9,cjs.Ease.quadOut).wait(38).to({x:-196.15},11).to({_off:true},1).wait(74));

	// HEAD2bHist
	this.instance_2 = new lib.HEAD2b_ID();
	this.instance_2.setTransform(-175.1,107.55,1.2386,1.2386,0,0,0,88.5,25);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(145).to({_off:false},0).to({x:246},9,cjs.Ease.quadOut).wait(54).to({x:-171.4},9,cjs.Ease.quintIn).to({_off:true},1).wait(132));

	// HEAD2bPlan
	this.instance_3 = new lib.HEAD2b_Plan();
	this.instance_3.setTransform(-297.7,107.55,1.2386,1.2386,0,0,0,88.5,25);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(91).to({_off:false},0).to({x:246},9,cjs.Ease.quintOut).wait(36).to({x:-306.4},9,cjs.Ease.quintIn).to({_off:true},1).wait(204));
	...
	this.instance_4.setTransform(532.85,126.55,0.5626,0.5626,0,0,0,97,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(154).to({_off:false},0).to({x:626.8},9).wait(45).to({x:767.45,y:267.2},11,cjs.Ease.quadIn).to({_off:true},1).wait(130));
	...
	this.instance_5.setTransform(767.45,267.2,0.5626,0.5626,0,0,0,97,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(86).to({_off:false},0).to({x:626.8,y:126.55},9).wait(59).to({x:721.3},9).to({_off:true},1).wait(186));

	// Calc
	this.instance_6 = new lib.Calc();
	this.instance_6.setTransform(837,350.8,0.6054,0.6054,0,0,0,181.1,283.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(220).to({_off:false},0).to({x:685.65,y:199.45},9).wait(47).to({x:837,y:350.8},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// iPhone
	this.instance_7 = new lib.iPhone_1();
	this.instance_7.setTransform(815.95,313.95,0.5626,0.5626,0,0,0,181.1,283.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(86).to({_off:false},0).to({regX:181,x:675.2,y:173.3},9).wait(113).to({regX:181.1,x:815.95,y:313.95},11,cjs.Ease.quadIn).to({_off:true},1).wait(130));

	// HEAD2a
	this.instance_8 = new lib.HEAD2a();
	this.instance_8.setTransform(246.65,63.7,1.2386,1.2386,0,0,0,90,17.1);
	...
	this.instance_9.setTransform(170,111.35,1,1,0,0,0,129.5,15.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(74).to({alpha:0},5).to({_off:true},1).wait(208).to({_off:false,regX:129.6,scaleX:1.4095,scaleY:1.4095,x:237.15,y:117.05,alpha:1},0).wait(62));

	// HEAD1
	this.instance_10 = new lib.HEAD1();
	this.instance_10.setTransform(1097.8,531.15,1.1935,1.1935,0,0,0,135.5,93);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(21).to({_off:false},0).to({x:754.1,y:187.45},25,cjs.Ease.quintOut).wait(34).to({x:1088.25,y:521.6},5,cjs.Ease.quadIn).to({_off:true},1).wait(264));

	// HEAD0
	this.instance_11 = new lib.HEAD0();
	this.instance_11.setTransform(527.8,116,1,1,0,0,0,83,25);
	...
	this.instance_13.setTransform(3,300,1,1,-90);
...
p.nominalBounds = new cjs.Rectangle(69,125,1326,860);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_Intro_970x250_atlas_P_1.png?1597609115995", id:"DD_Intro_970x250_atlas_P_1"},
		{src:"images/DD_Intro_970x250_atlas_NP_1.jpg?1597609115995", id:"DD_Intro_970x250_atlas_NP_1"}
	],
	preloads: []
};
