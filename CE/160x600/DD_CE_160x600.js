...
lib.ssMetadata = [
		{name:"DD_CE_160x600_atlas_P_1", frames: [[0,0,194,400],[0,402,194,400],[196,0,194,400],[196,402,194,400]]},
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-153,91.6,0.8131,0.8131,0,0,0,88.5,25.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(179).to({_off:false},0).to({x:83.5},9,cjs.Ease.quadOut).wait(40).to({x:-147.3},11).to({_off:true},1).wait(62));

	// HEAD2bHist
	this.instance_1 = new lib.HEAD2bHist();
	this.instance_1.setTransform(-153,91.6,0.8131,0.8131,0,0,0,88.5,25.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(135).to({_off:false},0).to({x:83.5},9,cjs.Ease.quadOut).wait(26).to({x:-152.15},9,cjs.Ease.quintIn).to({_off:true},1).wait(122));

	// HEAD2bPlan
	this.instance_2 = new lib.HEAD2bPlan();
	this.instance_2.setTransform(-152.15,91.6,0.8131,0.8131,0,0,0,88.5,25.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(91).to({_off:false},0).to({x:83.5},9,cjs.Ease.quintOut).wait(26).to({x:-152.15},9,cjs.Ease.quintIn).to({_off:true},1).wait(166));
	...
	this.instance_3.setTransform(-49.75,370.5,0.7575,0.7575,0,0,0,96.9,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(188).to({_off:false},0).to({regX:97,x:76.8},9).wait(31).to({regX:97.2,x:266.25,y:559.95},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));
	...
	this.instance_4.setTransform(-49.75,370.5,0.7575,0.7575,0,0,0,96.9,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(144).to({_off:false},0).to({regX:97,x:76.8},9).wait(35).to({regX:97.1,x:202.55},9).to({_off:true},1).wait(104));
	...
	this.instance_5.setTransform(266.25,559.95,0.7575,0.7575,0,0,0,97.2,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(86).to({_off:false},0).to({regX:97,x:76.8,y:370.5},9).wait(49).to({regX:97.1,x:204.05},9).to({_off:true},1).wait(148));

	// iPhone
	this.instance_6 = new lib.iPhone_1();
	this.instance_6.setTransform(331.3,622.9,0.7575,0.7575,0,0,0,181.1,283.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(86).to({_off:false},0).to({regX:181,regY:283.3,x:141.9,y:433.5},9).wait(133).to({regX:181.1,regY:283.2,x:331.3,y:622.9},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// HEAD2a
	this.instance_7 = new lib.HEAD2a();
	this.instance_7.setTransform(83.95,56.25,0.8131,0.8131,0,0,0,90,17.1);
	...
	this.instance_8.setTransform(209.5,129.35,1,1,0,0,0,129.5,15.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(74).to({alpha:0},5).to({_off:true},1).wait(160).to({_off:false,x:209.35,alpha:1},0).wait(62));

	// EndFrame1
	this.instance_9 = new lib.HEAD_MySmile();
	this.instance_9.setTransform(243.1,465.15,0.5604,0.5604,0,0,0,135.6,93);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(250).to({_off:false},0).to({x:81.7,y:303.75},25,cjs.Ease.quintOut).wait(27));

	// EndFrame0
	this.instance_10 = new lib.HEAD_WelcomeTo();
	this.instance_10.setTransform(126.65,197.9,0.5604,0.5604,0,0,0,83,25);
	...
	this.instance_11.setTransform(370.5,599.45,1,1,0,0,0,135.5,93);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(21).to({_off:false},0).to({x:82.5,y:311.45},25,cjs.Ease.quintOut).wait(34).to({x:362.5,y:591.45},5,cjs.Ease.quadIn).to({_off:true},1).wait(216));

	// HEAD0
	this.instance_12 = new lib.HEAD0();
	this.instance_12.setTransform(162.95,201,1,1,0,0,0,83,25);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_CE_160x600_atlas_P_1.png?1597686341772", id:"DD_CE_160x600_atlas_P_1"},
		{src:"images/DD_CE_160x600_atlas_NP_1.jpg?1597686341772", id:"DD_CE_160x600_atlas_NP_1"}
	],
	preloads: []
};
