...
}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(60,59,296,255.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(85,388.5,0.57,0.57,0,0,0,0.1,0.1);
	...
	this.instance_1.setTransform(303.55,432.4,0.7,0.7,0,0,0,197,132);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(240).to({_off:false},0).to({x:143.55,y:282.4},10,cjs.Ease.quadOut).wait(52));

	// HEAD2bDent
	this.instance_2 = new lib.HEAD2bDent();
	this.instance_2.setTransform(-153,91.6,0.8131,0.8131,0,0,0,88.5,25.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(179).to({_off:false},0).to({x:83.5},9,cjs.Ease.quadOut).wait(40).to({x:-147.3},11).to({_off:true},1).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(135).to({_off:false},0).to({x:83.5},9,cjs.Ease.quadOut).wait(26).to({x:-152.15},9,cjs.Ease.quintIn).to({_off:true},1).wait(122));

	// HEAD2bPlan
	this.instance_4 = new lib.HEAD2bPlan();
	this.instance_4.setTransform(-152.15,91.6,0.8131,0.8131,0,0,0,88.5,25.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(91).to({_off:false},0).to({x:83.5},9,cjs.Ease.quintOut).wait(26).to({x:-152.15},9,cjs.Ease.quintIn).to({_off:true},1).wait(166));
	...
	this.instance_5.setTransform(-49.75,370.5,0.7575,0.7575,0,0,0,96.9,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(188).to({_off:false},0).to({regX:97,x:76.8},9).wait(31).to({regX:97.2,x:266.25,y:559.95},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(144).to({_off:false},0).to({regX:97,x:76.8},9).wait(35).to({regX:97.1,x:202.55},9).to({_off:true},1).wait(104));
	...
	this.instance_7.setTransform(266.25,559.95,0.7575,0.7575,0,0,0,97.2,200.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(86).to({_off:false},0).to({regX:97,x:76.8,y:370.5},9).wait(49).to({regX:97.1,x:204.05},9).to({_off:true},1).wait(148));

	// iPhone
	this.instance_8 = new lib.iPhone_1();
	this.instance_8.setTransform(331.3,622.9,0.7575,0.7575,0,0,0,181.1,283.2);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(86).to({_off:false},0).to({regX:181,regY:283.3,x:141.9,y:433.5},9).wait(133).to({regX:181.1,regY:283.2,x:331.3,y:622.9},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// HEAD2a
	this.instance_9 = new lib.HEAD2a();
	this.instance_9.setTransform(83.95,56.25,0.8131,0.8131,0,0,0,90,17.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(74).to({alpha:0},5).to({_off:true},1).wait(160).to({_off:false,x:209.35,alpha:1},0).wait(62));
...
p.nominalBounds = new cjs.Rectangle(-144.9,300,735.9,537.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_CE_160x600_atlas_P_1.png?1597528266798", id:"DD_CE_160x600_atlas_P_1"},
		{src:"images/DD_CE_160x600_atlas_NP_1.jpg?1597528266798", id:"DD_CE_160x600_atlas_NP_1"}
	],
	preloads: []
};
