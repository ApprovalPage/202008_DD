...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(634.2,44.05,0.33,0.33,0,0,0,0.1,0.3);
	...
	this.instance_1.setTransform(516.5,229.3,1,1,0,0,0,197,132);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(240).to({_off:false},0).to({x:446.5,y:159.3},10,cjs.Ease.quadOut).wait(52));
	...
	this.instance_6.setTransform(230,23.35,1,1,0,0,0,129.5,15.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(74).to({alpha:0},5).to({_off:true},1).wait(160).to({_off:false,x:150,y:42.85,alpha:1},0).wait(62));

	// HEAD1
	this.instance_7 = new lib.HEAD1();
	this.instance_7.setTransform(573.4,209.2,0.6,0.56,0,0,0,135.7,93.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(21).to({_off:false},0).to({regX:135.6,regY:93.1,scaleY:0.6,x:442.35,y:72.85},25,cjs.Ease.quintOut).wait(34).to({regY:93,x:573.35,y:212.8},5,cjs.Ease.quadIn).to({_off:true},1).wait(216));

	// HEAD0
	this.instance_8 = new lib.HEAD0();
	this.instance_8.setTransform(182.95,69,1,1,0,0,0,83,25);
	...
	// bkgd
	this.instance_9 = new lib.CE300x600bkgd15();
	this.instance_9.setTransform(600,300,1,1,-90);

	this.instance_10 = new lib.CE300x600bkgd15();
	this.instance_10.setTransform(0,300,1,1,-90);
...
p.nominalBounds = new cjs.Rectangle(364,45,836,257.3);
// library properties:
lib.properties = {
