...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(150,458.5);
	...
	this.instance_4.setTransform(-181.5,115,1,1,0,0,0,88.5,25);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(188).to({_off:false},0).to({x:148},9).wait(31).to({x:398,y:640},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(144).to({_off:false},0).to({x:148},9).wait(35).to({x:314},9).to({_off:true},1).wait(104));
	...
	this.instance_7.setTransform(398,640,1,1,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(86).to({_off:false},0).to({x:148,y:390},9).wait(49).to({x:316},9).to({_off:true},1).wait(148));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(86).to({_off:false},0).to({x:234,y:473.1},9).wait(133).to({x:484,y:723.1},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));
