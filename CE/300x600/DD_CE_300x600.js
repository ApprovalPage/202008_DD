...
lib.ssMetadata = [
		{name:"DD_CE_300x600_atlas_P_1", frames: [[0,0,194,400],[0,402,250,247],[196,0,194,400],[392,0,194,400],[588,0,194,400]]},
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(150,526,1,1,0,0,0,0,25);
	...
	this.instance_1.setTransform(150,348.5);
	...
	this.instance_2.setTransform(493.5,528.95,1,1,0,0,0,197,132);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(240).to({_off:false},0).to({x:213.5,y:248.95},10,cjs.Ease.quadOut).wait(52));
	...
	this.instance_5.setTransform(-181.5,115,1,1,0,0,0,88.5,25);
	...
	this.instance_6.setTransform(-19,390,1,1,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(188).to({_off:false},0).to({x:148},9).wait(31).to({x:398,y:640},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));
	...
	this.instance_7.setTransform(-19,390,1,1,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(144).to({_off:false},0).to({x:148},9).wait(35).to({x:314},9).to({_off:true},1).wait(104));
	...
	this.instance_8.setTransform(398,640,1,1,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(86).to({_off:false},0).to({x:148,y:390},9).wait(49).to({x:316},9).to({_off:true},1).wait(148));

	// iPhone
	this.instance_9 = new lib.iPhone_1();
	this.instance_9.setTransform(484,723.1,1,1,0,0,0,181,283.1);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(86).to({_off:false},0).to({x:234,y:473.1},9).wait(133).to({x:484,y:723.1},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// HEAD2a
	this.instance_10 = new lib.HEAD2a();
	this.instance_10.setTransform(109,71.5,1,1,0,0,0,90,17);
	...
	this.instance_11.setTransform(150,129.35,1,1,0,0,0,129.5,15.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(74).to({alpha:0},5).to({_off:true},1).wait(160).to({_off:false,y:69.35,alpha:1},0).wait(62));

	// HEAD1
	this.instance_12 = new lib.HEAD1();
	this.instance_12.setTransform(440.5,599.45,1,1,0,0,0,135.5,93);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(21).to({_off:false},0).to({x:152.5,y:311.45},25,cjs.Ease.quintOut).wait(34).to({x:432.5,y:591.45},5,cjs.Ease.quadIn).to({_off:true},1).wait(216));

	// HEAD0
	this.instance_13 = new lib.HEAD0();
	this.instance_13.setTransform(102.95,185,1,1,0,0,0,83,25);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_CE_300x600_atlas_P_1.png?1597704339827", id:"DD_CE_300x600_atlas_P_1"},
		{src:"images/DD_CE_300x600_atlas_NP_1.jpg?1597704339827", id:"DD_CE_300x600_atlas_NP_1"}
	],
	preloads: []
};
