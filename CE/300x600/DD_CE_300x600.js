...
lib.ssMetadata = [
		{name:"DD_CE_300x600_atlas_P_1", frames: [[0,0,194,400],[0,402,194,400],[196,0,194,400],[196,402,194,400]]},
...
(lib.HEAD_WelcomeTo = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#5E4788").s().p("Ag6A5QgYgXAAgiIAAAAQAAggAYgXQAYgYAiAAQAkAAAXAXQAYAXAAAhIAAAAQAAAigYAWQgYAYgjAAQgiAAgYgXgAgcgcQgLAMAAAQIAAAAQAAARALAMQAMANAQAAQARgBAMgMQAKgLAAgSIAAAAQAAgQgKgMQgMgMgRAAQgQAAgMAMg");
	this.shape.setTransform(69.65,24.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#5E4788").s().p("AgVBNIAAhzIgtAAIAAgmICFAAIAAAmIguAAIAABzg");
	this.shape_1.setTransform(53.925,24.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#5E4788").s().p("Ag+BNIAAiZIB7AAIAAAkIhQAAIAAAXIBJAAIAAAhIhJAAIAAAZIBRAAIAAAkg");
	this.shape_2.setTransform(33.55,24.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#5E4788").s().p("AAoBNIAAhXIgoA7IAAAAIgng7IAABXIgqAAIAAiZIAtAAIAkA7IAkg7IAuAAIAACZg");
	this.shape_3.setTransform(16.45,24.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#5E4788").s().p("Ag7A5QgXgXAAgiIAAAAQAAggAYgXQAYgYAiAAQAjAAAZAXQAXAXAAAhIAAAAQAAAigYAWQgYAYgjAAQgjAAgYgXgAgbgcQgLAMAAAQIAAAAQAAARALAMQALANAQAAQARgBALgMQALgLAAgSIAAAAQAAgQgLgMQgLgMgRAAQgRAAgKAMg");
	this.shape_4.setTransform(-2.2,24.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#5E4788").s().p("AgxA6QgYgXAAgjIAAAAQAAghAXgXQAYgXAhAAQAqAAAYAgIggAZQgPgTgTABQgPAAgLAMQgKAMAAAQIAAAAQAAARAKAMQALAMAPAAQATAAAQgSIAgAWQgaAjgqAAQghAAgWgWg");
	this.shape_5.setTransform(-18.725,24.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#5E4788").s().p("Ag6BNIAAiZIArAAIAAB0IBKAAIAAAlg");
	this.shape_6.setTransform(-32.375,24.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#5E4788").s().p("Ag+BNIAAiZIB7AAIAAAkIhQAAIAAAXIBJAAIAAAhIhJAAIAAAZIBRAAIAAAkg");
	this.shape_7.setTransform(-46.65,24.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#5E4788").s().p("AAfBOIgfhYIgeBYIglAAIg0iaIAtAAIAbBYIAehZIAkAAIAdBZIAbhYIAtAAIg0Cag");
...
}).prototype = getMCSymbolPrototype(lib.HEAD_WelcomeTo, new cjs.Rectangle(-94.7,0,189.7,50), null);
...
if (reversed == null) { reversed = false; }
	...
	// shad
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#5E4788").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.HEAD_MySmile, new cjs.Rectangle(-3,0,323,363), null);
...
if (reversed == null) { reversed = false; }
	...
	// HEAD2bDent
	this.instance = new lib.HEAD2bDent();
	this.instance.setTransform(-182.55,115,1,1,0,0,0,88.5,25);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(179).to({_off:false},0).to({x:108.45},9,cjs.Ease.quadOut).wait(40).to({x:-175.5},11).to({_off:true},1).wait(62));

	// HEAD2bHist
	this.instance_1 = new lib.HEAD2bHist();
	this.instance_1.setTransform(-182.55,115,1,1,0,0,0,88.5,25);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(135).to({_off:false},0).to({x:108.45},9,cjs.Ease.quadOut).wait(26).to({x:-181.5},9,cjs.Ease.quintIn).to({_off:true},1).wait(122));

	// HEAD2bPlan
	this.instance_2 = new lib.HEAD2bPlan();
	this.instance_2.setTransform(-181.5,115,1,1,0,0,0,88.5,25);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(91).to({_off:false},0).to({x:108.45},9,cjs.Ease.quintOut).wait(26).to({x:-181.5},9,cjs.Ease.quintIn).to({_off:true},1).wait(166));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_188 = new cjs.Graphics().p("AtLZjMAAAgzFIaXAAMAAAAzFg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(188).to({graphics:mask_graphics_188,x:151.625,y:389.525}).wait(40).to({graphics:null,x:0,y:0}).wait(74));

	// screen-dentist
	this.instance_3 = new lib.screendentist_1();
	this.instance_3.setTransform(-19,390,1,1,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(188).to({_off:false},0).to({x:148},9).wait(31).to({x:398,y:640},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// mask copy 2 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_144 = new cjs.Graphics().p("AtLZjMAAAgzFIaXAAMAAAAzFg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(144).to({graphics:mask_1_graphics_144,x:151.625,y:389.525}).wait(54).to({graphics:null,x:0,y:0}).wait(104));

	// screen-history
	this.instance_4 = new lib.screenhistory_1();
	this.instance_4.setTransform(-19,390,1,1,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(144).to({_off:false},0).to({x:148},9).wait(35).to({x:314},9).to({_off:true},1).wait(104));

	// mask copy (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_95 = new cjs.Graphics().p("AtLZjMAAAgzFIaXAAMAAAAzFg");
	var mask_2_graphics_144 = new cjs.Graphics().p("AtLZjMAAAgzFIaXAAMAAAAzFg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(95).to({graphics:mask_2_graphics_95,x:151.625,y:389.525}).wait(49).to({graphics:mask_2_graphics_144,x:151.625,y:389.525}).wait(10).to({graphics:null,x:0,y:0}).wait(148));

	// screen-plan
	this.instance_5 = new lib.screenplan_1();
	this.instance_5.setTransform(398,640,1,1,0,0,0,97,200);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(86).to({_off:false},0).to({x:148,y:390},9).wait(49).to({x:316},9).to({_off:true},1).wait(148));

	// iPhone
	this.instance_6 = new lib.iPhone_1();
	this.instance_6.setTransform(484,723.1,1,1,0,0,0,181,283.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(86).to({_off:false},0).to({x:234,y:473.1},9).wait(133).to({x:484,y:723.1},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// HEAD2a
	this.instance_7 = new lib.HEAD2a();
	this.instance_7.setTransform(109,71.5,1,1,0,0,0,90,17);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(86).to({_off:false},0).wait(142).to({alpha:0},11).to({_off:true},1).wait(62));

	// logo
	this.instance_8 = new lib.DD_logo();
	this.instance_8.setTransform(150,129.35,1,1,0,0,0,129.5,15.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(74).to({alpha:0},5).to({_off:true},1).wait(160).to({_off:false,alpha:1},0).wait(62));

	// EndFrame1
	this.instance_9 = new lib.HEAD_MySmile();
	this.instance_9.setTransform(440.5,699.45,1,1,0,0,0,135.5,93);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(250).to({_off:false},0).to({x:152.5,y:411.45},25,cjs.Ease.quintOut).wait(27));

	// EndFrame0
	this.instance_10 = new lib.HEAD_WelcomeTo();
	this.instance_10.setTransform(232.85,235,1,1,0,0,0,83,25);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(240).to({_off:false},0).to({alpha:1},9).wait(53));

	// HEAD1
	this.instance_11 = new lib.HEAD1();
	this.instance_11.setTransform(440.5,599.45,1,1,0,0,0,135.5,93);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(21).to({_off:false},0).to({x:152.5,y:311.45},25,cjs.Ease.quintOut).wait(34).to({x:432.5,y:591.45},5,cjs.Ease.quadIn).to({_off:true},1).wait(216));

	// HEAD0
	this.instance_12 = new lib.HEAD0();
	this.instance_12.setTransform(102.95,185,1,1,0,0,0,83,25);
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#C1B7D2").ss(6,1,0,3).p("EgW9guZMAt7AAAMAAABczMgt7AAAg");
...
p.nominalBounds = new cjs.Rectangle(-121,300,965.3,706.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_CE_300x600_atlas_P_1.png?1597685444567", id:"DD_CE_300x600_atlas_P_1"},
		{src:"images/DD_CE_300x600_atlas_NP_1.jpg?1597685444567", id:"DD_CE_300x600_atlas_NP_1"}
	],
	preloads: []
};
