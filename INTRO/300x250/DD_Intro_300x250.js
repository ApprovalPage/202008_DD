...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(493.5,499.9,1,1,0,0,0,197,132);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(288).to({_off:false},0).to({x:213.5,y:219.9},10,cjs.Ease.quadOut).wait(52));

	// HEAD2b_CE
	this.instance_1 = new lib.HEAD2b_EstCosts();
	this.instance_1.setTransform(-143.2,28.85,0.8,0.8,0,0,0,88.5,25.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(217).to({_off:false},0).to({x:89.55},9,cjs.Ease.quadOut).wait(38).to({x:-137.55},11).to({_off:true},1).wait(74));

	// HEAD2b_ID
	this.instance_2 = new lib.HEAD2b_ID();
	this.instance_2.setTransform(-143.2,60.9,0.8,0.8,0,0,0,88.5,25.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(145).to({_off:false},0).to({x:89.55},9,cjs.Ease.quadOut).wait(54).to({x:-142.35},9,cjs.Ease.quintIn).to({_off:true},1).wait(132));

	// HEAD2b_Plan
	this.instance_3 = new lib.HEAD2b_Plan();
	this.instance_3.setTransform(-142.35,60.9,0.8,0.8,0,0,0,88.5,25.1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(91).to({_off:false},0).to({x:89.55},9,cjs.Ease.quintOut).wait(36).to({x:-142.35},9,cjs.Ease.quintIn).to({_off:true},1).wait(204));
	...
	this.instance_4.setTransform(79.5,167.8,0.3887,0.3887,0,0,0,96.9,200.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(154).to({_off:false},0).to({regX:97.1,x:144.4},9).wait(45).to({x:311.6,y:334.95},11,cjs.Ease.quadIn).to({_off:true},1).wait(130));
	...
	this.instance_5.setTransform(311.6,334.95,0.3887,0.3887,0,0,0,97.1,200.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(86).to({_off:false},0).to({x:144.4,y:167.8},9).wait(59).to({regX:97.2,x:209.75},9).to({_off:true},1).wait(186));

	// Calc
	this.instance_6 = new lib.Calc();
	this.instance_6.setTransform(375.95,387.4,0.5403,0.5403,0,0,0,181.2,283.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(220).to({_off:false},0).to({regX:181.1,x:200.85,y:212.35},9).wait(47).to({regX:181.2,x:375.95,y:387.4},11,cjs.Ease.quadIn).to({_off:true},1).wait(62));

	// iPhone
	this.instance_7 = new lib.iPhone_1();
	this.instance_7.setTransform(345,367.25,0.3887,0.3887,0,0,0,181,283.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(86).to({_off:false},0).to({regX:181.1,regY:283.1,x:177.85,y:200.05},9).wait(113).to({regX:181,regY:283.2,x:345,y:367.25},11,cjs.Ease.quadIn).to({_off:true},1).wait(130));

	// HEAD2a
	this.instance_8 = new lib.HEAD2a();
	this.instance_8.setTransform(89.95,32.5,0.8,0.8,0,0,0,90,17.1);
	...
	this.instance_9.setTransform(150,55.3,1,1,0,0,0,129.5,15.3);
	...
	this.instance_10.setTransform(440.5,525.4,1,1,0,0,0,135.5,93);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(21).to({_off:false},0).to({x:152.5,y:237.4},25,cjs.Ease.quintOut).wait(34).to({x:432.5,y:517.4},5,cjs.Ease.quadIn).to({_off:true},1).wait(264));

	// HEAD0
	this.instance_11 = new lib.HEAD0();
	this.instance_11.setTransform(232.85,110.95,1,1,0,0,0,83,25);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/DD_Intro_300x250_atlas_P_1.png", id:"DD_Intro_300x250_atlas_P_1"},
		{src:"images/DD_Intro_300x250_atlas_NP_1.jpg", id:"DD_Intro_300x250_atlas_NP_1"}
	],
	preloads: []
};
